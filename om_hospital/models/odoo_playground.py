...
class OdooPlayGround(models.Model):
    ...
    # - self.env.is.system: Return whether the current user has "Settings", or is in Superuser mode 
    # - self.env.is.admin: Return whether the current user has "Access Rights", or is in Superuser mode 
    # - self.env.is.superuser: Return whether the environment is in Superuser mode 
